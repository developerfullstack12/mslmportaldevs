...
function gamipress_time_based_rewards_ajax_claim() {
    ...
    $time_based_reward = get_post( $time_based_reward_id );
     ...
     * @param array     $rewards
     */
    $rewards_popup_output = apply_filters( 'gamipress_time_based_rewards_rewards_popup_output', $rewards_popup_output, $user_rewards );
