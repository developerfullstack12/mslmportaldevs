...
<div class="wrap">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card">
                    <img class="card-img-top" src="<?php echo PERSONAL_DICTIONARY_ADMIN_URL;?>/images/icons/icon-quiz-128x128.png" alt="Quiz Maker">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card">
                    <img class="card-img-top" src="<?php echo PERSONAL_DICTIONARY_ADMIN_URL; ?>/images/icons/icon-survey-128x128.png" alt="Survey Maker">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card">
                    <img class="card-img-top" src="<?php echo PERSONAL_DICTIONARY_ADMIN_URL; ?>/images/icons/icon-128x128.png" alt="Poll Maker">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card">
                    <img class="card-img-top" src="<?php echo PERSONAL_DICTIONARY_ADMIN_URL; ?>/images/icons/icon-gallery-128x128.png" alt="Gallery - Photo Gallery">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card">
                    <img class="card-img-top" src="<?php echo PERSONAL_DICTIONARY_ADMIN_URL; ?>/images/icons/icon-sccp-128x128.png" alt="Secure Copy Content Protection">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card">
                    <img class="card-img-top" src="<?php echo PERSONAL_DICTIONARY_ADMIN_URL; ?>/images/icons/icon-popup-128x128.png" alt="Popup Box">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card">
                    <img class="card-img-top" src="<?php echo PERSONAL_DICTIONARY_ADMIN_URL; ?>/images/icons/icon-fb-popup-128x128.png" alt="Facebook Popup Likebox">
                    <div class="card-body">
