(function($){$('body').on('submit','.gamipress-transfers-form',function(e){e.preventDefault();return!1});$('body').on('keypress','.gamipress-transfers-form',function(e){return e.keyCode!=13});$('body').on('click','.gamipress-transfers-form .gamipress-transfers-form-submit-button',function(e){e.preventDefault();var $this=$(this);var form=$this.closest('.gamipress-transfers-form');var submit_wrap=form.find('.gamipress-transfers-form-submit');var recipient_input=form.find('.gamipress-transfers-recipient-form-recipient-input');var recipient_id=parseInt(form.find('input[name="recipient_id"]').val());var user_points=parseInt(form.find('input[name="user_points"]').val());if(submit_wrap.find('.gamipress-transfers-form-response').length===0)
submit_wrap.prepend('<div class="gamipress-transfers-form-response" style="display: none;"></div>')
var response_wrap=submit_wrap.find('.gamipress-transfers-form-response');if(recipient_input.length&&!recipient_input.hasClass('.gamipress-transfers-recipient-form-recipient-autocomplete'))
recipient_id=-1;if(isNaN(recipient_id)||recipient_id===0){response_wrap.addClass('gamipress-transfers-error');response_wrap.html(gamipress_transfers.no_recipient_error);response_wrap.slideDown();return}
