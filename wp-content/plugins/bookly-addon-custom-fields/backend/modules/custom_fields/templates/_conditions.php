    ...
    <div class="form-row align-items-center mb-3 bookly-js-custom-fields-condition">
        ...
        <div class="col">
            <select class="form-control bookly-js-custom-fields-target">
                <?php foreach ( $custom_fields as $custom_field ) : ?>
                    <option value="<?php echo $custom_field->id ?>"><?php echo $custom_field->label ?></option>
                <?php endforeach; ?>
            </select>
        </div>
        ...
        <div class="col">
            <select class="form-control bookly-js-custom-fields-equal">
                <option value="1"><?php esc_html_e( 'equals' ) ?></option>
                <option value="0"><?php esc_html_e( 'not equals' ) ?></option>
            </select>
        </div>
        <div class="col">
            <select class="form-control bookly-js-custom-fields-values">
                <?php foreach ( $first_custom_field->items as $item ) : ?>
