...
class LD_GB_QuickStart {
	...
	function mock_gradebook_table_columns( $columns ) {
		...
		return array(
			'display_name'        => __( 'User', 'learndash-gradebook' ),
					...
					'content_pieces' => array(
						...
						sprintf( 
							preg_replace( 
								'/(\d+)%/',
								'$1%%',
								__( 'Completion Grading applies to %s and %s. By default, they will not count towards the final grade until they are marked complete, at which point they count for a 100% grade. If you set this to "Fail until completion", then any %s and %s not yet marked complete will count for a 0% grade.', 'learndash-gradebook' )
							),
