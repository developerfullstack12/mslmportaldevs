                        ...
                        <?php 
                            ...
                            printf( 
                                preg_replace( 
                                    '/(\d+)%/',
                                    '$1%%',
                                    __( 'Previously, you had to add %s points into a new Gradebook field on each %s. Now you can simply use the native "Points" system for %s! Simply enable points from the %s or %s you desire, and then each %s will have a place to enter points, which will automatically average into a 0-100% scale.', 'learndash-gradebook' ),
                                ),
