...
class LD_GB_SC_ReportCard extends LD_GB_Shortcode {
	...
	function __construct() {
		...
		add_action( 'report-card-overall-grade', array( __CLASS__, 'template_overall_grade' ), 10, 3 );
		add_action( 'report-card-component', array( __CLASS__, 'template_component' ), 10, 4 );
		add_action( 'report-card-component-toggle', array( __CLASS__, 'template_component_toggle' ), 10, 4 );
		add_action( 'report-card-component-info', array( __CLASS__, 'template_component_title' ), 10, 5 );
		add_action( 'report-card-component-info', array( __CLASS__, 'template_component_grade' ), 20, 5 );
	 ...
	 */
	static function template_overall_grade( $user_grade, $gradebook_id, $grade_format = 'letter' ) {
	 ...
	 * @param string $grade_format
	 */
	static function template_component( $component, $user_grade, $gradebook_id, $grade_format = 'letter' ) {
	 ...
	 * @param string $grade_format
	 */
	static function template_component_title( $component, $user_grade, $gradebook_id, $component_handle, $grade_format = 'letter' ) {
	 ...
	 * @param string $grade_format
	 */
	static function template_component_grade( $component, $user_grade, $gradebook_id, $component_handle, $grade_format = 'letter' ) {
