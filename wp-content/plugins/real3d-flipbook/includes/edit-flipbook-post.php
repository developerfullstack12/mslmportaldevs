   ...
   <input type="hidden" name="bookId" value="<?php echo($current_id);?>">
         ...
         <div>
            ...
            <div id="tab-toc" style="display:none;">
               <p class="description">Create custom Table of Contents. This overrides default PDF outline or table of contents created by page titles.</p>
               <p>
            ...
            <div id="tab-mobile"  style="display:none;">
               <p class="description">Override settings for mobile devices (use different view mode, smaller textures ect)</p>
            ...
            <div id="tab-menu"  style="display:none;">
               <!-- <div id="poststuff"> -->
                  <div class="meta-box-sortables">
                     ...
                     <div class="postbox closed">
                        <button type="button" class="handlediv" aria-expanded="true"><span class="screen-reader-text">Toggle panel: Share on Whatsapp</span><span class="toggle-indicator" aria-hidden="true"></span></button>
                        <h2 class="hndle ui-sortable-handle"><span>Share on Whatsapp</span></h2>
                        <div class="inside">
                           <table class="form-table" id="flipbook-whatsapp-options">
                              <tbody></tbody>
                           </table>
                           <div class="clear"></div>
                        </div>
                  ...
                  <div class="page-preview">
                     <div class="thumbnail thumbnail-image">
                        ...
                        <div class="attachment-actions">
                           ...
                           <button type="button" class="button replace-page">Replace Image</button>
