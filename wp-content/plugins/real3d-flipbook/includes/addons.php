...
<div class='wrap r3d_wrap'>
  ...
  <div class="addons">
  	...
  	<div class="addons-block">
  		...
  		<h1>Add more features to Real3D Flipbook</h1>

  		<p>Make Real3D Flipbook more powerful with add-ons</p>
  		...
  		<div class="addons-banner-block-items">
  			...
  			<div class="addons-banner-block-item">
  				...
  				<div class="addons-banner-block-item-content">
  					...
  					<a class="button button-primary button-large addons-button" href="https://codecanyon.net/item/real3d-flipbook-addons/32839910?ref=creativeinteractivemedia&ref2=admin_addons" target="_blank">Buy Now $29</a>
