<?php
/******************************************************************************************
 * @name:       validate-avatar-data.php - part of WP plugin for creating vector avatars
 * @version:    1.7
 ...
 *
 * Validate file name, type, and PNG or SVG data. Sanitize downloading file name.
*******************************************************************************************/
function svgAvatars_validate_filename( $name ) {
	...
	// the file extensions must be exactly png or svg
...
// white-listing all the SVG code
