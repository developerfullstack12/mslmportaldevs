...
trait Post_Grid_Markup {
    ...
    public static function render_grid_primary_markup_garbez( $settings = '', $posts = '' ) {

        ?>
		<div class="ha-pg-item">
			<div class="ha-pg-thumb-area has-post-thumb">
				<a href="#" class="ha-pg-thumb">
					<img src="http://localhost/happy-test/wp-content/uploads/2011/07/img_0513-1-2.jpg" alt="">
				</a>
				<div class="ha-pg-cat">
					<a href="#">Life Style</a>
				</div>
			...
			<div class="ha-pg-content-area">
				<h3 class="ha-pg-title">
					<a href="#">Best travel plan for your next vacation plan for your next vacation</a>
				</h3>
				<div class="ha-pg-meta-wrap">
					<ul>
						<li class="ha-pg-author">
				...
				<div class="ha-pg-excerpt">
					<p>It sounds funny to think that a little Chihuahua would be able to stop a thief. If you think about it, other than yapping.It sounds funny to think that a little Chihuahua would be able to stop a thief. If you think about it, other than yapping.It sounds funny to think that a little Chihuahua would be able to stop a thief. If you think about it, other than yapping...</p>
				</div>
				<div class="ha-pg-readmore">
					<a href="#">
						Continue Reading »
					</a>
				</div>
		...
		<div class="ha-pg-item">
			...
			<div class="ha-pg-content-area">
				...
				<div class="ha-pg-excerpt">
					<p>It sounds funny to think that a little Chihuahua would be able to stop a thief. If you think about it, other than yapping...</p>
				</div>
				<div class="ha-pg-readmore">
					<a href="#">
						Continue Reading »
