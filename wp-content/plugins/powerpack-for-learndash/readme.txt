...
Powerpack for LearnDash offers 50 modules you can activate in a click to power up your LearnDash LMS website. 

What’s included with PowerPack for LearnDash?

== Description ==

**PowerPack for LearnDash** plugin allows you to control various aspects of your LearnDash site without code! Powering up your LearnDash website. Included are 50 modules which are. 
...
* Bypass LearnDash lesson drip-feed logic for admin users [Will be deprecated on 29-07-2021]
...
* Disable use of transients [Will be deprecated on 29-07-2021]
...
* Include admin users In displays and reporting [Will be deprecated on 29-07-2021]
* Display matrix sorting question 2 column layout [Will be deprecated on 29-07-2021]
* Change the outgoing email address of ProPanel emails
* Disable auto enrolled admin users in courses [Will be deprecated on 29-07-2021]
...
* Remove cookie on lesson completion (video progression) [Will be deprecated on 29-07-2021]
* Remove video progression cookie on topic completion [Will be deprecated on 29-07-2021]
...
== Screenshots ==
1. 50 Modules all ready to use with the slide of a toggle.
