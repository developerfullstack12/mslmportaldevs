 ...
 */
define( 'LD_POWERPACK_VERSION', '1.3.0' );
 ...
 */
new License(
	__( 'PowerPack for LearnDash', 'learndash-powerpack' ),
	6859,
	'powerpack-for-learndash',
	__FILE__,
	LD_POWERPACK_VERSION
);
...
function learndash_powerpack_missing_learndash_notice() {
	echo '<div class="notice notice-error is-dismissible"><p><strong>' . sprintf( esc_html__( 'Learndash PowerPack requires LearnDash to be installed and active. You can download %s here.', 'learndash-powerpack' ), '<a href="https://www.learndash.com/" target="_blank">LearnDash</a>' ) . '</strong></p></div>';
}
