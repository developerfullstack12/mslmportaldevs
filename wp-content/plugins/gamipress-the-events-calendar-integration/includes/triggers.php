...
function gamipress_the_events_calendar_activity_triggers( $triggers ) {
    ...
    $triggers[__( 'The Events Calendar', 'gamipress-the-events-calendar-integration' )] = array(

        // Publishing
        'gamipress_publish_' . $event_post_type           => __( 'Publish a new event', 'gamipress-the-events-calendar-integration' ), // Internal GamiPress listener
        'gamipress_delete_' . $event_post_type            => __( 'Delete an event', 'gamipress-the-events-calendar-integration' ),     // Internal GamiPress listener
    );

    if( class_exists( 'Tribe__Tickets__Main' ) ) {
        $triggers[__( 'Event Tickets', 'gamipress-the-events-calendar-integration' )] = array(
            // RSVP
            'gamipress_the_events_calendar_rsvp_event'                      => __( 'Confirm RSVP for an event', 'gamipress-the-events-calendar-integration' ),
            'gamipress_the_events_calendar_rsvp_specific_event'             => __( 'Confirm RSVP for a specific event', 'gamipress-the-events-calendar-integration' ),

            // Purchase tickets
            'gamipress_the_events_calendar_purchase_ticket'                 => __( 'Purchase a ticket for an event', 'gamipress-the-events-calendar-integration' ),
            'gamipress_the_events_calendar_purchase_ticket_specific_event'  => __( 'Purchase a ticket for a specific event', 'gamipress-the-events-calendar-integration' ),

            // Checkin
            'gamipress_the_events_calendar_checkin_event'                      => __( 'Check-in at an event', 'gamipress-the-events-calendar-integration' ),
            'gamipress_the_events_calendar_checkin_specific_event'             => __( 'Check-in at specific event', 'gamipress-the-events-calendar-integration' ),
        );
    }
...
function gamipress_the_events_calendar_specific_activity_trigger_label( $specific_activity_trigger_labels ) {
    ...
    $specific_activity_trigger_labels['gamipress_the_events_calendar_rsvp_specific_event'] = __( 'Confirm RSVP for %s event', 'gamipress-the-events-calendar-integration' );
    $specific_activity_trigger_labels['gamipress_the_events_calendar_purchase_ticket_specific_event'] = __( 'Purchase a ticket for %s event', 'gamipress-the-events-calendar-integration' );
    $specific_activity_trigger_labels['gamipress_the_events_calendar_checkin_specific_event'] = __( 'Check-in at %s event', 'gamipress-the-events-calendar-integration' );
