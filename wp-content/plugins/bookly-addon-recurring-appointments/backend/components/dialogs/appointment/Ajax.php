...
class Ajax extends BooklyLib\Base\Ajax
{
    ...
    public static function getSchedule()
    {
        ...
        $display_tz = BooklyLib\Utils\Common::getCurrentUserTimeZone();
        $wp_tz = BooklyLib\Config::getWPTimeZone();
        if ( $display_tz !== $wp_tz ) {
            $params['time_zone'] = BooklyLib\Utils\Common::getCurrentUserTimeZone();
            $params['time_zone_offset'] = BooklyLib\Utils\DateTime::timeZoneOffset( $params['time_zone'] );
            $datetime = BooklyLib\Utils\DateTime::convertTimeZone( $datetime, $display_tz, $wp_tz );
        }
