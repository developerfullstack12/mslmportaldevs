    ...
    <div class="bookly-row">
        <div class="bookly-checkbox-group">
            ...
            <label for="bookly-repeat-<?php echo $random_id ?>">
                <?php echo Common::getTranslatedOption( 'bookly_l10n_repeat_this_appointment' ) ?>
            </label>
        </div>
    </div>
    <div class="bookly-js-repeat-variants-container">
        <div class="bookly-row">
            <div class="bookly-col-2 bookly-col-label">
                <?php echo Common::getTranslatedOption( 'bookly_l10n_repeat' ) ?>
            </div>
                ...
                <select class="bookly-js-repeat-variant bookly-control">
                    <?php foreach ( array( 'daily', 'weekly', 'biweekly', 'monthly' ) as $type ) :
                        if ( isset( $frequencies[ $type ] ) ) : ?>
                            <option value="<?php echo $type ?>"><?php echo Common::getTranslatedOption( 'bookly_l10n_repeat_' . $type ) ?></option>
                        <?php endif ?>
                    <?php endforeach ?>
                </select>
            </div>
            <div class="bookly-js-variant-daily bookly-col-1 bookly-text-center bookly-margin-top">
                <?php echo Common::getTranslatedOption( 'bookly_l10n_repeat_every' ) ?>
            </div>
            ...
            <div class="bookly-js-variant-daily bookly-col-1 bookly-visible-md bookly-text">
                <?php echo Common::getTranslatedOption( 'bookly_l10n_repeat_days' ) ?>
            </div>
        </div>
        <div class="bookly-js-variant-weekly bookly-js-variant-biweekly">
            <div class="bookly-row">
                <div class="bookly-col-2 bookly-visible-md" style="text-align: right;">
                    <?php echo Common::getTranslatedOption( 'bookly_l10n_repeat_on_week' ) ?>
                </div>
                <div class="bookly-col-10">
                    <?php if ( ! empty ( $week ) ) : ?>
                        ...
                        <div class="bookly-js-days-error bookly-label-error" style="display: none;">
                            <?php echo Common::getTranslatedOption( 'bookly_l10n_repeat_required_week_days' ) ?>
                        </div>
                    <?php endif ?>
                </div>
            </div>
        ...
        <div class="bookly-js-variant-monthly">
            <div class="bookly-row">
                <div for="bookly-repeat-on" class="bookly-col-2 bookly-col-label">
                    <?php echo Common::getTranslatedOption( 'bookly_l10n_repeat_on' ) ?>
                </div>
                <div class="bookly-col-4">
                    <select class="bookly-js-repeat-variant-monthly bookly-control">
                        <option value="specific"><?php echo Common::getTranslatedOption( 'bookly_l10n_repeat_specific' ) ?></option>
                        <option value="first"><?php echo Common::getTranslatedOption( 'bookly_l10n_repeat_first' ) ?></option>
                        <option value="second"><?php echo Common::getTranslatedOption( 'bookly_l10n_repeat_second' ) ?></option>
                        <option value="third"><?php echo Common::getTranslatedOption( 'bookly_l10n_repeat_third' ) ?></option>
                        <option value="fourth"><?php echo Common::getTranslatedOption( 'bookly_l10n_repeat_fourth' ) ?></option>
                        <option value="last"><?php echo Common::getTranslatedOption( 'bookly_l10n_repeat_last' ) ?></option>
                    </select>
                </div>
                <div class="bookly-col-2 bookly-visible-sm bookly-margin-top">
                    <?php echo Common::getTranslatedOption( 'bookly_l10n_repeat_day' ) ?>
                </div>
        ...
        <div class="bookly-row">
            <div class="bookly-col-2 bookly-col-label">
                <?php echo Common::getTranslatedOption( 'bookly_l10n_repeat_until' ) ?>
            </div>
            <div class="bookly-col-4">
            ...
            <div class="bookly-col-1 bookly-text-center bookly-margin-top">
                <?php echo Common::getTranslatedOption( 'bookly_l10n_repeat_or' ) ?>
            </div>
            <div class="bookly-col-2">
                <input type="number" step="1" min="1" class="bookly-js-repeat-times" value="" data-value=""/>
            </div>
            <div class="bookly-col-1 bookly-text">
                <?php echo Common::getTranslatedOption( 'bookly_l10n_repeat_times' ) ?>
            </div>
        </div>
        <div class="bookly-row">
            ...
            <div class="bookly-col-10">
                <button class="bookly-btn bookly-get-schedule bookly-js-get-schedule" data-style="zoom-in" data-spinner-size="40">
                    <span class="ladda-label"><?php echo Common::getTranslatedOption( 'bookly_l10n_repeat_schedule' ) ?></span>
                </button>
            </div>
        </div>
        <div class="bookly-js-schedule-container" style="display: none">
                ...
                <div class="bookly-schedule-row">
                    ...
                    <div class="bookly-schedule-appointment">
                        ...
                        <div class="bookly-hidden-info">
                            <span>
                                <?php echo Common::getTranslatedOption( 'bookly_l10n_repeat_deleted' ) ?>
                            </span>
                            <div class="bookly-rounds-group">
                        ...
                        <div class="bookly-schedule-intersect" style="display: none;">
                            ...
                            <?php echo Common::getTranslatedOption( 'bookly_l10n_repeat_another_time' ) ?>
                        </div>
                        <div class="bookly-label-error" style="display: none">
                            <?php echo Common::getTranslatedOption( 'bookly_l10n_repeat_no_available_slots' ) ?>
                        </div>
                    </div>
                </div>
            </div>
            <div class="bookly-row bookly-well bookly-js-schedule-help">
                ...
                <div>
                    <?php echo nl2br( Common::getTranslatedOption( 'bookly_l10n_repeat_schedule_info' ) ) ?>
                </div>
            </div>
            <div class="bookly-row">
...
<div class="bookly-box bookly-nav-steps">
    ...
    <div class="<?php echo get_option( 'bookly_app_align_buttons_left' ) ? 'bookly-left' : 'bookly-right' ?>">
        <button class="bookly-next-step bookly-js-next-step bookly-btn ladda-button" data-style="zoom-in" data-spinner-size="40">
            <span class="ladda-label"><?php echo Common::getTranslatedOption( 'bookly_l10n_step_repeat_button_next' ) ?></span>
        </button>
    </div>
</div>